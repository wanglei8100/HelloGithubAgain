...
public final class SwipeWaitZhongCiActivity_
    extends SwipeWaitZhongCiActivity
    implements HasViews, OnViewChangedListener
{
    ...
    public static SwipeWaitZhongCiActivity_.IntentBuilder_ intent(Context context) {
        return new SwipeWaitZhongCiActivity_.IntentBuilder_(context);
    }

    public static SwipeWaitZhongCiActivity_.IntentBuilder_ intent(android.app.Fragment fragment) {
        return new SwipeWaitZhongCiActivity_.IntentBuilder_(fragment);
    }

    public static SwipeWaitZhongCiActivity_.IntentBuilder_ intent(android.support.v4.app.Fragment supportFragment) {
        return new SwipeWaitZhongCiActivity_.IntentBuilder_(supportFragment);
    }
            ...
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View view) {
                        SwipeWaitZhongCiActivity_.this.onClick(view);
                    }
    ...
    public void toast(final String paramString) {
        handler_.post(new Runnable() {
            ...
            @Override
            public void run() {
                SwipeWaitZhongCiActivity_.super.toast(paramString);
            }
    ...
    public void checkDevice() {
        BackgroundExecutor.execute(new BackgroundExecutor.Task("", 0, "") {
            ...
            public void execute() {
                try {
                    SwipeWaitZhongCiActivity_.super.checkDevice();
                } catch (Throwable e) {
    ...
    public void statEmvSwiper() {
        BackgroundExecutor.execute(new BackgroundExecutor.Task("", 0, "") {
            ...
            public void execute() {
                try {
                    SwipeWaitZhongCiActivity_.super.statEmvSwiper();
                } catch (Throwable e) {
                    Thread.getDefaultUncaughtExceptionHandler().uncaughtException(Thread.currentThread(), e);
                }
            }
    ...
    public static class IntentBuilder_
        extends ActivityIntentBuilder<SwipeWaitZhongCiActivity_.IntentBuilder_>
    {
        ...
        public IntentBuilder_(Context context) {
            super(context, SwipeWaitZhongCiActivity_.class);
        }

        public IntentBuilder_(android.app.Fragment fragment) {
            super(fragment.getActivity(), SwipeWaitZhongCiActivity_.class);
            fragment_ = fragment;
        }
        ...
        public SwipeWaitZhongCiActivity_.IntentBuilder_ blue_address(String blue_address) {
            return super.extra(BLUE_ADDRESS_EXTRA, blue_address);
        }

        public SwipeWaitZhongCiActivity_.IntentBuilder_ feeRate(String feeRate) {
            return super.extra(FEE_RATE_EXTRA, feeRate);
        }

        public SwipeWaitZhongCiActivity_.IntentBuilder_ money(String money) {
            return super.extra(MONEY_EXTRA, money);
        }

        public SwipeWaitZhongCiActivity_.IntentBuilder_ queryModel(QueryModel queryModel) {
            return super.extra(QUERY_MODEL_EXTRA, ((Serializable) queryModel));
        }

        public SwipeWaitZhongCiActivity_.IntentBuilder_ topFeeRate(String topFeeRate) {
            return super.extra(TOP_FEE_RATE_EXTRA, topFeeRate);
        }

        public SwipeWaitZhongCiActivity_.IntentBuilder_ tradetype(String tradetype) {
