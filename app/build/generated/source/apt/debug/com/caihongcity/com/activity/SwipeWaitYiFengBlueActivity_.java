...
public final class SwipeWaitYiFengBlueActivity_
    extends SwipeWaitYiFengBlueActivity
    implements HasViews, OnViewChangedListener
{
    ...
    public static SwipeWaitYiFengBlueActivity_.IntentBuilder_ intent(Context context) {
        return new SwipeWaitYiFengBlueActivity_.IntentBuilder_(context);
    }

    public static SwipeWaitYiFengBlueActivity_.IntentBuilder_ intent(android.app.Fragment fragment) {
        return new SwipeWaitYiFengBlueActivity_.IntentBuilder_(fragment);
    }

    public static SwipeWaitYiFengBlueActivity_.IntentBuilder_ intent(android.support.v4.app.Fragment supportFragment) {
        return new SwipeWaitYiFengBlueActivity_.IntentBuilder_(supportFragment);
    }
            ...
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View view) {
                        SwipeWaitYiFengBlueActivity_.this.onClick(view);
                    }
    ...
    public void dialogShow(final String s) {
        handler_.post(new Runnable() {
            ...
            @Override
            public void run() {
                SwipeWaitYiFengBlueActivity_.super.dialogShow(s);
            }
    ...
    public void toast(final String paramString) {
        handler_.post(new Runnable() {
            ...
            @Override
            public void run() {
                SwipeWaitYiFengBlueActivity_.super.toast(paramString);
            }
    ...
    public void query(final String url) {
        BackgroundExecutor.execute(new BackgroundExecutor.Task("", 0, "") {
            ...
            public void execute() {
                try {
                    SwipeWaitYiFengBlueActivity_.super.query(url);
                } catch (Throwable e) {
    ...
    public void toBindTerminal() {
        BackgroundExecutor.execute(new BackgroundExecutor.Task("", 0, "") {
            ...
            public void execute() {
                try {
                    SwipeWaitYiFengBlueActivity_.super.toBindTerminal();
                } catch (Throwable e) {
                    Thread.getDefaultUncaughtExceptionHandler().uncaughtException(Thread.currentThread(), e);
                }
            }
    ...
    public void statSwiper() {
        BackgroundExecutor.execute(new BackgroundExecutor.Task("", 0, "") {
            ...
            public void execute() {
                try {
                    SwipeWaitYiFengBlueActivity_.super.statSwiper();
                } catch (Throwable e) {
                    Thread.getDefaultUncaughtExceptionHandler().uncaughtException(Thread.currentThread(), e);
                }
            }
    ...
    public static class IntentBuilder_
        extends ActivityIntentBuilder<SwipeWaitYiFengBlueActivity_.IntentBuilder_>
    {
        ...
        public IntentBuilder_(Context context) {
            super(context, SwipeWaitYiFengBlueActivity_.class);
        }

        public IntentBuilder_(android.app.Fragment fragment) {
            super(fragment.getActivity(), SwipeWaitYiFengBlueActivity_.class);
            fragment_ = fragment;
        }
        ...
        public SwipeWaitYiFengBlueActivity_.IntentBuilder_ tradetype(String tradetype) {
            return super.extra(TRADETYPE_EXTRA, tradetype);
        }

        public SwipeWaitYiFengBlueActivity_.IntentBuilder_ blue_address(String blue_address) {
            return super.extra(BLUE_ADDRESS_EXTRA, blue_address);
        }

        public SwipeWaitYiFengBlueActivity_.IntentBuilder_ money(String money) {
            return super.extra(MONEY_EXTRA, money);
        }

        public SwipeWaitYiFengBlueActivity_.IntentBuilder_ queryModel(QueryModel queryModel) {
            return super.extra(QUERY_MODEL_EXTRA, ((Serializable) queryModel));
        }

        public SwipeWaitYiFengBlueActivity_.IntentBuilder_ feeRate(String feeRate) {
            return super.extra(FEE_RATE_EXTRA, feeRate);
        }

        public SwipeWaitYiFengBlueActivity_.IntentBuilder_ topFeeRate(String topFeeRate) {
