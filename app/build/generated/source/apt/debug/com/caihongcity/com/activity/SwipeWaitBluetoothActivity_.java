...
public final class SwipeWaitBluetoothActivity_
    extends SwipeWaitBluetoothActivity
    implements HasViews, OnViewChangedListener
{
    ...
    public static SwipeWaitBluetoothActivity_.IntentBuilder_ intent(Context context) {
        return new SwipeWaitBluetoothActivity_.IntentBuilder_(context);
    }

    public static SwipeWaitBluetoothActivity_.IntentBuilder_ intent(android.app.Fragment fragment) {
        return new SwipeWaitBluetoothActivity_.IntentBuilder_(fragment);
    }

    public static SwipeWaitBluetoothActivity_.IntentBuilder_ intent(android.support.v4.app.Fragment supportFragment) {
        return new SwipeWaitBluetoothActivity_.IntentBuilder_(supportFragment);
    }
            ...
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View view) {
                        SwipeWaitBluetoothActivity_.this.onClick(view);
                    }
    ...
    public void toast(final String paramString) {
        handler_.post(new Runnable() {
            ...
            @Override
            public void run() {
                SwipeWaitBluetoothActivity_.super.toast(paramString);
            }
    ...
    public void statEmvSwiper() {
        BackgroundExecutor.execute(new BackgroundExecutor.Task("", 0, "") {
            ...
            public void execute() {
                try {
                    SwipeWaitBluetoothActivity_.super.statEmvSwiper();
                } catch (Throwable e) {
    ...
    public void getKSN() {
        BackgroundExecutor.execute(new BackgroundExecutor.Task("", 0, "") {
            ...
            public void execute() {
                try {
                    SwipeWaitBluetoothActivity_.super.getKSN();
                } catch (Throwable e) {
                    Thread.getDefaultUncaughtExceptionHandler().uncaughtException(Thread.currentThread(), e);
                }
            }
    ...
    public static class IntentBuilder_
        extends ActivityIntentBuilder<SwipeWaitBluetoothActivity_.IntentBuilder_>
    {
        ...
        public IntentBuilder_(Context context) {
            super(context, SwipeWaitBluetoothActivity_.class);
        }

        public IntentBuilder_(android.app.Fragment fragment) {
            super(fragment.getActivity(), SwipeWaitBluetoothActivity_.class);
            fragment_ = fragment;
        }
        ...
        public SwipeWaitBluetoothActivity_.IntentBuilder_ feeRate(String feeRate) {
            return super.extra(FEE_RATE_EXTRA, feeRate);
        }

        public SwipeWaitBluetoothActivity_.IntentBuilder_ blue_address(String blue_address) {
            return super.extra(BLUE_ADDRESS_EXTRA, blue_address);
        }

        public SwipeWaitBluetoothActivity_.IntentBuilder_ money(String money) {
            return super.extra(MONEY_EXTRA, money);
        }

        public SwipeWaitBluetoothActivity_.IntentBuilder_ tradetype(String tradetype) {
            return super.extra(TRADETYPE_EXTRA, tradetype);
        }

        public SwipeWaitBluetoothActivity_.IntentBuilder_ queryModel(QueryModel queryModel) {
            return super.extra(QUERY_MODEL_EXTRA, ((Serializable) queryModel));
        }

        public SwipeWaitBluetoothActivity_.IntentBuilder_ topFeeRate(String topFeeRate) {
