...
public class SwipeWaitMoFangActivity extends BaseActivity implements View.OnClickListener {
    ...
    private String pinkey; //通过workKey截出来的pinkey
    ...
    void dialogShow(String s) {
        ...
        dialog = ViewUtils.createLoadingDialog(SwipeWaitMoFangActivity.this, s, true);
        dialog.show();
    ...
    void getKSN() {
        ...
        //logger.error("测试ksn的数据" + result.commResult);
    ...
    private void connPos() {
        //POS未连接，连接POS
        ConnectPosResult rc = Controler.connectPos("");
        if (rc.bConnected) {
            dialogShow("设备连接成功");
        } else {
            toast("设备连接失败,请重试");
    ...
    private void initDialogConsume() {
        ...
        if(maskedPAN != null) {
            maskedPANValue = maskedPAN.replace(maskedPAN.subSequence(6, maskedPAN.length() - 4), "****");
        }else{
            toast("读卡失败，请确认芯片卡是否插反");
            return;
        }
        formatmoney = CommonUtils.format(money);
        customDialog = new CustomDialog(SwipeWaitMoFangActivity.this, R.style.mystyle, R.layout.customdialog, "￥ " + formatmoney, maskedPANValue);
    ...
    private void initConsumeUrl(String pwdVal) {
        ...
        //检查网络状态
        if (CommonUtils.getConnectedType(SwipeWaitMoFangActivity.this) == -1) {
            ViewUtils.makeToast(SwipeWaitMoFangActivity.this, getString(R.string.nonetwork), 1500);
            return;
        }
        trade(url);
            ...
            public void isLoadedContent(String paramString) {
                ...
                try {
                    ...
                    if ("00".equals(result)) {
                        ...
                        localIntent.setClass(SwipeWaitMoFangActivity.this, SignNameActivity.class);
                        ...
                        if("密码错误".equals(resultValue)) {
                            tag = 1;
                            toBindTerminal();
                            ViewUtils.makeToast(SwipeWaitMoFangActivity.this, "密码错误", 1500);
                        }else {
    ...
    private void initDialogQuery() {
        ...
        if(maskedPAN != null) {
            ...
            customDialog = new CustomDialog(SwipeWaitMoFangActivity.this, R.style.mystyle, R.layout.customdialog, "余额查询", maskedPANValue);
            ...
            public void isLoadedContent(String paramString) {
                ...
                try {
                    ...
                    if ("00".equals(result)) {
                        ...
                        localIntent.setClass(SwipeWaitMoFangActivity.this, QueryBalancceResultActivity.class);
                        startActivity(localIntent);
                        finish();
                        ViewUtils.overridePendingTransitionCome(SwipeWaitMoFangActivity.this);
                        return;
                ...
                if (resultStartEmv.execResult.equals(CommEnum.STARTEMVRESULT.SUCC)
                    ...
                    if (getResult.commResult.equals(CommEnum.COMMRET.NOERROR)) {
                        if (getResult.pan != null) {
                            ...
                            LogUtil.syso("ic55域数据" + ic55DataStr);
                        }
                    }
            ...
            public void isLoadedContent(String content) {
                ...
                try {
                    ...
                    if ((REPONSE_STATUS.equals(bindStatus)) || (REPEAT_BIND.equals(bindStatus))) {
                        ...
                        //从41域中拿到终端号
                        terminal = obj.getString("41");
                        LogUtil.syso("workKey get=====" + workKey);
                        StorageCustomerInfoUtil.putInfo(SwipeWaitMoFangActivity.this, "terminal", terminal);
                        StorageCustomerInfoUtil.putInfo(SwipeWaitMoFangActivity.this, "workkey", workKey);
                        if(tag == 1){
                            toast("SWIPE_OK");
                            tag = 0;
                            return;
...
//                }
    ...
    private void showNoDeviceDialog() {
        ViewUtils.showChoseDialog(SwipeWaitMoFangActivity.this, true, "请插入刷卡头后重试", View.GONE, new ViewUtils.OnChoseDialogClickCallback() {
            @Override
            public void clickOk() {
                ViewUtils.overridePendingTransitionBack(SwipeWaitMoFangActivity.this);
            }
