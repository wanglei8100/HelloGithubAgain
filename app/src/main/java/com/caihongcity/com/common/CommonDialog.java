...
public class CommonDialog extends Dialog{
	...
	private static CommonDialog myDialog = null;
	private CommonDialog(Context context,String showContent){
		super(context);
	...
	public static Dialog getDialog(Context context,String showContent){
		if(myDialog==null){
			myDialog = new CommonDialog(context, showContent);
			myDialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
			View view  = LayoutInflater.from(context).inflate(R.layout.confirmdialog, null);
