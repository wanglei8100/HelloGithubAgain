...
public class GridPasswordView extends LinearLayout implements PasswordView {
    ...
    private com.caihongcity.com.view.ImeDelBugFixedEditText inputView;
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (textSize != -1) {
            this.textSize = CommonUtils.px2sp(context, textSize);
        }

        lineWidth = (int) ta.getDimension(R.styleable.gridPasswordView_lineWidth, CommonUtils.dp2px(getContext(), 1));
    ...
    private void initViews(Context context) {
        ...
        transformationMethod = new com.caihongcity.com.view.CustomPasswordTransformationMethod(passwordTransformation);
    ...
    private void inflaterViews(Context context) {
        ...
        inputView = (com.caihongcity.com.view.ImeDelBugFixedEditText) findViewById(R.id.inputView);
    ...
    private com.caihongcity.com.view.ImeDelBugFixedEditText.OnDelKeyEventListener onDelKeyEventListener = new com.caihongcity.com.view.ImeDelBugFixedEditText.OnDelKeyEventListener() {
    ...
    @Override
    public void setPasswordType(com.caihongcity.com.view.PasswordType passwordType) {
